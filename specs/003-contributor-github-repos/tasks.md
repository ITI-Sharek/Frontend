...
- [ ] T022 Run `pnpm lint` and fix surfaced issues
- [ ] T023 Run `pnpm test` and fix surfaced issues
- [ ] T024 Run `pnpm build` and fix surfaced issues
- [ ] T025 Confirm `git status --short` excludes forbidden files except pre-existing 001 changes and includes only this feature's intended changes
