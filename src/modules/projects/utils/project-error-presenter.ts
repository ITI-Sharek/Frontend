...
const PROJECT_ERROR_MESSAGES: Record<string, string> = {
  ...
  PROJECT_HERO_IMAGE_REQUIRED: "project.errors.heroImageRequired",
  PROJECT_HERO_IMAGE_INVALID: "project.errors.heroImageInvalid",
  PROJECT_HERO_IMAGE_NOT_FOUND: "project.errors.heroImageNotFound",
