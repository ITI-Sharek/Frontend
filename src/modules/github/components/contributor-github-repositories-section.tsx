...
function RepositoryCard({
  ...
  return (
    <Card
      className={
        isSelected
          ? "border-primary bg-primary/5 p-5"
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div className="flex min-w-0 flex-col gap-2">
            <button
              type="button"
              onClick={onSelect}
              className="w-fit max-w-full cursor-pointer text-right"
...
function getLanguageEntries(languages: Record<string, number>) {
